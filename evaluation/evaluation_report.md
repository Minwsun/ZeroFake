...
**Ngày đánh giá**: 2025-12-20 19:46:58
**Tổng số mẫu**: 2
...
| **Reasoning Consistency** | 100.00% | Lý do khớp với kết luận |

## TẦNG 3: HIỆU NĂNG HỆ THỐNG (Operational Metrics)

| Chỉ số | Giá trị | Mục tiêu |
|--------|---------|----------|
| **Latency trung bình** | 21.48s | < 15s |
| **Latency P50** | 21.48s | - |
| **Latency P95** | 22.50s | - |
| **Latency tối đa** | 22.61s | - |
| **Cache Hit Rate** | 0.00% | - |
